...
export default function WhatsAppDock() {
  return (
    <a
      ...
      className="wa-dock fixed bottom-5 right-5 z-50 grid h-14 w-14 place-items-center rounded-full bg-toy-green text-white shadow-[0_18px_36px_-14px_rgba(32,20,54,0.7)] transition-transform hover:-translate-y-1"
    >
